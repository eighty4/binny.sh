...
//     try {
//         let packageJson = import.meta.resolve('../node_modules/@eighty4/binny-template/package.json')
...
//     } catch (e) {
//         throw new Error('failed resolving version of @eighty4/binny-template')
//     }
// }

...
export const ARCHITECTURES: Readonly<Array<Architecture>> = Object.freeze([
    'aarch64',
    'arm',
    'x86_64',
])
...
export const OPERATING_SYSTEMS: Readonly<Array<OperatingSystem>> =
    Object.freeze(['Linux', 'MacOS', 'Windows'])

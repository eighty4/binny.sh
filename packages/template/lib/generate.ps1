...
if ($os -eq 'Windows') {
    if ($arch -eq 'aarch64') {
        $filename = '***BIN_Windows_aarch64***'
    } elseif ($arch -eq 'x86_64') {
        $filename = '***BIN_Windows_x86_64***'
    }
} elseif ($os -eq 'Linux') {
    if ($arch -eq 'aarch64') {
        $filename = '***BIN_Linux_aarch64***'
    } elseif ($arch -eq 'x86_64') {
        $filename = '***BIN_Linux_x86_64***'
    } else {
        $filename = '***BIN_Linux_arm***'
    }
} elseif ($os -eq 'MacOS') {
    if ($arch -eq 'aarch64') {
        $filename = '***BIN_MacOS_aarch64***'
    } elseif ($arch -eq 'x86_64') {
        $filename = '***BIN_MacOS_x86_64***'
    }
}

import cloneTemplate from 'Binny.sh/dom/cloneTemplate'
...
export default class SpinIndicator extends HTMLElement {
    ...
    static templateHTML(): string {
        return `
            <template id="${SpinIndicator.TEMPLATE_ID}">
    ...
    connectedCallback() {
        this.shadowRoot!.appendChild(cloneTemplate(SpinIndicator.TEMPLATE_ID))
    }
